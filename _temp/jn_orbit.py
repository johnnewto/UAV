...
class OrbitNavigator:
    def __init__(self, client=None, radius = 2, altitude = 10, speed = 2, iterations = 1, center = [1,0], snapshots = None):
        self.radius = radius
...
def setup_env():
    ...
    pose = airsim.Pose(position_val=airsim.Vector3r(5.0, 0.0, -10.0), )
...
if __name__ == "__main__":
    ...
    nav = OrbitNavigator(client, args.radius, args.altitude, args.speed, args.iterations, args.center.split(','), args.snapshots)
    nav.start()
    # rs.exit()