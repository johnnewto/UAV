# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/05_gstreamer.valve.ipynb.

# %% auto 0
__all__ = ['logger', 'DefaultParams', 'GstStream', 'ping_ip', 'Mqtt', 'main']

# %% ../nbs/05_gstreamer.valve.ipynb 5
...
# %% ../nbs/05_gstreamer.valve.ipynb 6
logging.basicConfig(format='%(asctime)-8s,%(msecs)-3d %(levelname)5s [%(filename)10s:%(lineno)3d] %(message)s',
                    datefmt='%H:%M:%S',
                    level=logging.INFO)  # Todo add this to params
logger = logging.getLogger(__name__)

# %% ../nbs/05_gstreamer.valve.ipynb 7
# gi.require_version('Gst', '1.0')

# %% ../nbs/05_gstreamer.valve.ipynb 10
#|code-fold: true
...
# %% ../nbs/05_gstreamer.valve.ipynb 15
#|code-fold: true
...
# %% ../nbs/05_gstreamer.valve.ipynb 20
...
# %% ../nbs/05_gstreamer.valve.ipynb 21
@patch
...
# %% ../nbs/05_gstreamer.valve.ipynb 22
@patch
...
# %% ../nbs/05_gstreamer.valve.ipynb 26
...
# %% ../nbs/05_gstreamer.valve.ipynb 30
class Mqtt:
...
# %% ../nbs/05_gstreamer.valve.ipynb 34
#|code-fold: true
...
# %% ../nbs/05_gstreamer.valve.ipynb 40
