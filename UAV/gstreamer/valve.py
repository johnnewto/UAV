...
# %% auto 0
__all__ = ['logger', 'DefaultParams', 'GstStream', 'ping_ip', 'Mqtt', 'gst_main']
...
def gst_main(camera="CAM-0"):
    ...
    with  GstStream(camera, gstcommand) as video, Mqtt("CAM-0", video) as mqtt:
        ...
        # # todo mqtt broker rplace with simple socket
        # print("# todo mqtt broker rplace with simple socket  ")      
        ...
        if not gststream.frame_available():
