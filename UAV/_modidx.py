...
d = { 'settings': { 'branch': 'main',
                ...
                'lib_path': 'UAV'},
  'syms': { 'UAV.airsim_client': { 'UAV.airsim_client.AirSimClient': ('api/airsim_client.html#airsimclient', 'UAV/airsim_client.py'),
                                   'UAV.airsim_client.AirSimClient.__init__': ( 'api/airsim_client.html#airsimclient.__init__',
                                                                                'UAV/airsim_client.py'),
                                   'UAV.airsim_client.AirSimClient.check_asset_exists': ( 'api/airsim_client.html#airsimclient.check_asset_exists',
                                                                                          'UAV/airsim_client.py'),
                                   'UAV.airsim_client.AirSimClient.get_image': ( 'api/airsim_client.html#airsimclient.get_image',
                                                                                 'UAV/airsim_client.py'),
                                   'UAV.airsim_client.AirSimClient.get_images': ( 'api/airsim_client.html#airsimclient.get_images',
                                                                                  'UAV/airsim_client.py'),
                                   'UAV.airsim_client.AirSimClient.get_state': ( 'api/airsim_client.html#airsimclient.get_state',
                                                                                 'UAV/airsim_client.py'),
                                   'UAV.airsim_client.AirSimClient.place_object': ( 'api/airsim_client.html#airsimclient.place_object',
                                                                                    'UAV/airsim_client.py'),
                                   'UAV.airsim_client.AirSimClient.takeoff': ( 'api/airsim_client.html#airsimclient.takeoff',
                                                                               'UAV/airsim_client.py')},
            ...
            'UAV.template.o1': {},
            'UAV.template01': {},
            'UAV.utils.display': { 'UAV.utils.display.VideoWriter': ('api/utils.display.html#videowriter', 'UAV/utils/display.py'),
