...
# %% auto 0
__all__ = ['boot_time', 'boot_time_str', 'MAV_SYSTEM_GCS_CLIENT', 'MAV_TYPE_GCS', 'MAV_SYSTEM_VEHICLE', 'MAV_TYPE_CAMERA',
           'MAV_COMP_ID_CAMERA', 'MAV_COMP_ID_USER1', 'get_linenumber', 'format_rcvd_msg', 'time_since_boot_ms',
           'time_UTC_usec', 'date_time_str', 'BaseComponent', 'MAVCom', 'test_MAVCom']
...
# %% ../../nbs/api/20_mavlink.mavcom.ipynb 11
def get_linenumber():
    cf = currentframe()
...
# %% ../../nbs/api/20_mavlink.mavcom.ipynb 12
...
# %% ../../nbs/api/20_mavlink.mavcom.ipynb 13
class BaseComponent:
...
# %% ../../nbs/api/20_mavlink.mavcom.ipynb 14
class MAVCom:
    """
    ...
    def add_component(self, comp):
        ...
        # comp.mav_connection = self
        comp.start_mav_connection(self)
