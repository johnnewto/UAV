# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/api/20_mavlink.base_old.ipynb.

# %% auto 0
__all__ = ['UAV_SYSTEM_GCS_CLIENT_ID', 'MAV_TYPE_GCS', 'UAV_SYSTEM_VEHICLE_ID', 'MAV_TYPE_CAMERA', 'MavLinkBase',
           'test_client_server']

# %% ../../nbs/api/20_mavlink.base_old.ipynb 7
import time, os, sys
...
# %% ../../nbs/api/20_mavlink.base_old.ipynb 10
...
class MavLinkBase:
    ...
    def __init__(self, connection_string, # "udpin:localhost:14550"
        ...
        self.message_cnts = {'rcvd_from_sys':{'MSG_TYPE':'count'}} # message counts, indexed by system and message type
    ...
    def listen(self):
        ...
        while not self._t_mav_listen_stop:
            ...
            if msg.get_type() == 'COMMAND_LONG':
                ...
                self.log.info(f"Received PING {msg}")
                if self.is_server:  # only servers respond to pings
                    self.send_ping()
...
def test_client_server(debug=False):
